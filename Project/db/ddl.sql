...
values ('Oppo 5x', '4', 'abcoppo', 1200, 'abc', 10),
       ('Oppo 5x1', '4', 'abcoppo', 1300, 'abc', 10),
       ('Oppo 5x2', '4', 'abcoppo', 1400, 'abc', 10),
       ('Samsung Galaxy X2', '2', 'abcoppo', 1500, 'def', 3),
       ('Samsung Galaxy X3', '2', 'abcoppo', 1520, 'def', 3),
       ('Samsung Galaxy X4', '2', 'abcoppo', 1540, 'def', 3),
       ('IPhone XS2', '1', 'abcoppo', 2100, 'ghk', 5),
       ('IPhone XS3', '1', 'abcoppo', 2140, 'ghk', 5),
       ('IPhone XS4', '1', 'abcoppo', 2123, 'ghk', 5),
       ('IPhone XS Max1', '1', 'abcoppo', 2530, 'abc', 12),
       ('IPhone XS Max12', '1', 'abcoppo', 2600, 'abc', 12),
       ('IPhone XS Max2', '1', 'abcoppo', 2540, 'abc', 12),
       ('Xiaomi ABC2', '3', 'abcoppo', 1030, 'abc', 15),
       ('Xiaomi ABC3', '3', 'abcoppo', 1200, 'abc', 15),
       ('Xiaomi ABC4', '3', 'abcoppo', 1040, 'abc', 15);
